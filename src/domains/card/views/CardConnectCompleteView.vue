...
<template>
  <CardPageLayout bg="screen" @back="returnToHome">
    ...
    <div
      v-if="ownedCardsStore.failedIssuerCount > 0"
      class="mt-5 flex items-start gap-3 rounded-md border border-warning/20 bg-warning/6 px-4 py-3 text-warning"
    >
    ...
    <ul
      class="overflow-hidden rounded-md bg-card shadow-tile"
