    ...
    >
      ...
      >
        <span
          ...
          :class="{
            'bg-[#E8A54F]': item.benefitType === '할인',
            'bg-[#75B27D]': item.benefitType === '캐시백',
            'bg-brown': item.benefitType === '포인트',
            'bg-[#4B9CC6]': item.benefitType === '마일리지',
            'bg-brown-light': !item.benefitType,
          }"
          aria-hidden="true"
        />
