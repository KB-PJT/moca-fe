...
describe('notification navigation', () => {
  it('실적 마감 알림은 리포트 화면으로 이동한다', () => {
    ...
    expect(resolveNotificationPath(data)).toBe('/report?from=notification')
  })
  ...
  it('실적 마감 알림은 카드 ID가 없어도 리포트 화면으로 이동한다', () => {
  ...
  it('REPORT target만 있어도 리포트 화면으로 이동한다', () => {
    const data = { target: 'REPORT' }
